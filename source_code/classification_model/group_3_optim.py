...
# Average CV score on the training set was: 0.8751244395862049
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=KNeighborsClassifier(n_neighbors=23, p=2, weights="uniform")),
    ExtraTreesClassifier(bootstrap=False, criterion="entropy", max_features=0.6000000000000001, min_samples_leaf=3, min_samples_split=5, n_estimators=100)
)
